...
class Alpha1Q1Engine(BaseEngine):
    """Alpha-1 Q1 Large Cap — rank 1-200 by 24h futures volume.

    Strategy params: trail 0.45-0.55x ATR, R:R 2.0:1, POC filter 2%, min hold 4 bars.
