...
class Alpha1V5b5PctReverseConfig(BaseConfig):
    ALPHA_ID: str = "alpha-1-v5b-5pct-reverse-blacklist-reverse-5pct"
    ...
    INITIAL_FIXED_TP_SL_PCT: float = 0.05  # fixed TP/SL used during MIN_HOLD_BARS
...
settings = Alpha1V5b5PctReverseConfig()
