...
class Alpha1Q2Engine(BaseEngine):
    """Alpha-1 Q2 Mid Cap — rank 200-400 by 24h futures volume.

    Strategy params: trail 0.60-0.80x ATR, R:R 2.5:1, POC filter 2.5%, min hold 6 bars.
