...
class Alpha1V5b28PctReverseConfig(BaseConfig):
    ALPHA_ID: str = "alpha-1-v5b-2-8pct-reverse-blacklist-reverse-2-8pct"
    ...
    INITIAL_FIXED_TP_SL_PCT: float = 0.028  # fixed TP/SL used during MIN_HOLD_BARS
...
settings = Alpha1V5b28PctReverseConfig()
